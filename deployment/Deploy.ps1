...
az webapp config set -g $ResourceGroupForDeployment -n $WebAppNameAdmin --always-on false  --output $azCliOutput
...
az webapp config set -g $ResourceGroupForDeployment -n $WebAppNamePortal --always-on false --output $azCliOutput
